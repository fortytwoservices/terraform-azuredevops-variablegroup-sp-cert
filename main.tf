/*
* # DevOps Variable Group with App Registration certificate
*
* This is the repository for our variablegroup-sp-cert module, which will create a new self signed certificate for an Azure AD app registration and put it into an Azure DevOps variable group.
*/
